...
public:
    ...
    virtual int32_t insertRun(int number, std::string configName, std::string network, std::time_t date, const char* penetrationRateOEM, const char* penetrationRateNonOEM);
